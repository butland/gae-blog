    ...
    init: function () {
        ...
        this.addBtn('highlight', 'Code HighLight', function(redactor_object, event, button_key) {
            ...
            redactor_object.modalInit('Code HighLight', '<div id="code_highlight">' +
                '<select id="language" name="language"><option value="awk">Awk</option><option value="bash">Bash</option><option value="c">C</option><option value="csharp">C#</option><option value="cpp">C++</option><option value="cmake">CMake</option><option value="css">CSS</option><option value="clojure">Clojure</option><option value="coffee-script">CoffeeScript</option><option value="common-lisp">Common Lisp</option><option value="d">D</option><option value="dart">Dart</option><option value="delphi">Delphi</option><option value="erlang">Erlang</option><option value="fortran">Fortran</option><option value="go">Go</option><option value="groovy">Groovy</option><option value="html">HTML</option><option value="json">JSON</option><option value="java">Java</option><option value="jsp">Java Server Page</option><option value="js">JavaScript</option><option value="lua">Lua</option><option value="make">Makefile</option><option value="mysql">MySQL</option><option value="nginx">Nginx configuration file</option><option value="objective-c">Objective-C</option><option value="php">PHP</option><option value="plpgsql">PL/pgSQL</option><option value="perl">Perl</option><option value="python">Python</option><option value="python3">Python 3</option><option value="rb">Ruby</option><option value="scala">Scala</option><option value="xml">XML</option><option value="yaml">YAML</option></select>' +
